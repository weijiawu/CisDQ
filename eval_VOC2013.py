...
#             print(name)
            if input_type == 'png':
                predict_file = os.path.join(predict_folder,name.split("/")[-1]+".png")
#                 print(predict_file)
                print(predict_file)
            ...
            gt_file = os.path.join(gt_folder,name.split("/")[-1]+".png")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--list", default='./datasets/PascalVOC12/ImageSets/Segmentation/val.txt', type=str)
    parser.add_argument("--predict_dir", default='./demo/cisdq/voc', type=str)
    parser.add_argument("--gt_dir", default='./datasets/PascalVOC12/SegmentationClassAug', type=str)
