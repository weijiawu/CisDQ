...
tasks_ade = {
    "offline": {
        0: [x for x in range(150)]
    },
    "100-50": {
        0: [x for x in range(0, 100)],
        1: [x for x in range(100, 150)]
    },
    "100-10":
        {
            0: [x for x in range(0, 100)],
            1: [x for x in range(100, 110)],
            2: [x for x in range(110, 120)],
            3: [x for x in range(120, 130)],
            4: [x for x in range(130, 140)],
            5: [x for x in range(140, 150)]
        },
    "100-5":
        {
            0: [x for x in range(0, 100)],
            1: [x for x in range(100, 105)],
            2: [x for x in range(105, 110)],
            3: [x for x in range(110, 115)],
            4: [x for x in range(115, 120)],
            5: [x for x in range(120, 125)],
            6: [x for x in range(125, 130)],
            7: [x for x in range(130, 135)],
            8: [x for x in range(135, 140)],
            9: [x for x in range(140, 145)],
            10: [x for x in range(145, 150)]
        },
    "50-50":
        {
            0: [x for x in range(0, 50)],
            1: [x for x in range(50, 100)],
            2: [x for x in range(100, 150)]
        },
}
...
def load_sem_seg(gt_root, image_root, training_classes, gt_ext="png", image_ext="jpg"):
    ...
    print(f'filter {len(dataset_dicts)} samples for training')
...
def register_all_ade20k_full(root):
    ...
    gt_dir = os.path.join(root, 'annotations_detectron2/training')

    for task,split in tasks_ade.items():
        nsteps = len(split.values())
        step_list = list(range(nsteps))

        # 为每个step分别注册标注信息
        for step, training_classes in split.items():
            new_name = f"ade20k_incremental_{task}_{step}"
            ...
            MetadataCatalog.get(new_name).set(
                ...
                training_classes = tasks_ade[task][step],
                task = task,
                step = step,
