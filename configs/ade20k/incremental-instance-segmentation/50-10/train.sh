...
wdir="output/ade20kins/50-10_cisdq"

python train_net.py --num-gpus 8 \
--config-file configs/ade20k/incremental-instance-segmentation/50-10/step1.yaml \
...
python train_net.py --num-gpus 8 \
--config-file configs/ade20k/incremental-instance-segmentation/50-10/step2.yaml \
...
python train_net.py --num-gpus 8 \
--config-file configs/ade20k/incremental-instance-segmentation/50-10/step3.yaml \
...
python train_net.py --num-gpus 8 \
--config-file configs/ade20k/incremental-instance-segmentation/50-10/step4.yaml \
...
python train_net.py --num-gpus 8 \
--config-file configs/ade20k/incremental-instance-segmentation/50-10/step5.yaml \
