...
wdir="output/cocoins/40-4_cisdq4"

python train_net.py --num-gpus 8 \
--config-file configs/coco/incremental-instance-segmentation/40-4/step1.yaml \
...
python train_net.py --num-gpus 8 \
--config-file configs/coco/incremental-instance-segmentation/40-4/step2.yaml \
...
python train_net.py --num-gpus 8 \
--config-file configs/coco/incremental-instance-segmentation/40-4/step3.yaml \
...
python train_net.py --num-gpus 8 \
--config-file configs/coco/incremental-instance-segmentation/40-4/step4.yaml \
...
python train_net.py --num-gpus 8 \
--config-file configs/coco/incremental-instance-segmentation/40-4/step5.yaml \
...
python train_net.py --num-gpus 8 \
--config-file configs/coco/incremental-instance-segmentation/40-4/step6.yaml \
...
python train_net.py --num-gpus 8 \
--config-file configs/coco/incremental-instance-segmentation/40-4/step7.yaml \
...
python train_net.py --num-gpus 8 \
--config-file configs/coco/incremental-instance-segmentation/40-4/step8.yaml \
...
python train_net.py --num-gpus 8 \
--config-file configs/coco/incremental-instance-segmentation/40-4/step9.yaml \
...
python train_net.py --num-gpus 8 \
--config-file configs/coco/incremental-instance-segmentation/40-4/step10.yaml \
